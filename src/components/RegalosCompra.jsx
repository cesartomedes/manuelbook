    ...
    const items = [
      {
        ...
        description:
          "Crea tu ebook fácil y rápido, copia y pega",
        price: "$7.000",
      },
      {
        title: "Plantillas editables para crear tu página en Hotmart",
        description:
          "Diseños y textos listos para usar y adaptar",
        price: "$6.000",
      },
      {
        title: "Checklist completo para lanzar tu ebook digital",
        description:
          "El paso a paso para que realmente vendas",
        price: "$12.000",
      },
    ];
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <h2 className="text-center font-extrabold text-4xl sm:text-5xl md:text-6xl leading-tight">
            Con la compra de la guía te llevás{" "}
